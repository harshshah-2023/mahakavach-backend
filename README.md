...
A high-performance, event-driven backend service powering real-time crowd monitoring and safety intelligence for urban rail transit systems. Built with FastAPI and WebSockets for low-latency data distribution and horizontal scalability.
